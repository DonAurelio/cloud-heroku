...
BROKER_URL='sqs://sqs.us-west-2.amazonaws.com/660158453105/aucar-sqs-D-celery//'
...
@app.task
def process_video_from_s3(company_name,contest_name,video_name,video_id, web_url,email_rcv):
    return process_s3_video(company_name,contest_name,video_name,video_id, web_url,email_rcv)
